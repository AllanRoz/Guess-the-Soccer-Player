...
export function EncyclopediaPage({ onNavigate }) {
      ...
      <div className="mb-8">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-stadium-900 border border-stadium-700 rounded-xl pl-10 pr-4 py-3 text-white placeholder-stadium-500 focus:outline-none focus:border-pitch-500"
          />
        </div>
      </div>
...
function PlayerCard({ player }) {
  return (
    <motion.div
      ...
      className="glass-card rounded-xl p-4 border-stadium-700 hover:border-pitch-500/50 transition-all"
    >
